...
Why bother to build a full-chain upstream game, put all the state and logic on the chain, and deal with all the complexity that comes with it. The reason is simple 😊, just to get the features that traditional game infrastructure does not have.
